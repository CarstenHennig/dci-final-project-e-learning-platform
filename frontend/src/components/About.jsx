      ...
      <div className="about_carousel">
        <Carousel fade>
          <Carousel.Item className="d-flex justify-content-center">
            <img className="d-block w-50 about-img" src={Pic1} alt="First slide" />
          ...
          <Carousel.Item className="d-flex justify-content-center">
            <img className="d-block w-50 about-img " src={Pic2} alt="Second slide" />
          ...
          <Carousel.Item className="d-flex justify-content-center">
            <img className="d-block w-50 about-img " src={Pic3} alt="Third slide" />
