...
function Imprint() {
  return (
    <div className="imprint">
      ...
      <p>
        Represented by: Mrs. Karin Yahud || Mr. Ferdinand Mbecha || Mr. Carsten
        Hennig
      </p>
      <p>Contact person:</p>
      ...
      <p>
        ...
        the content is up-to-date, reliable or complete. According to the legal
        regulations we are responsible for the content created by ourselves. In
        this context, we would like to clarify that we are not responsible for
        information provided by or collected from third parties. We neither
        control the information that is sent, nor do we follow up on possible
        illegal activities. If illegal activities are detected, we will follow
        our obligation to block or delete the corresponding content, according
        to paragraphs 8 to 10 of the Telemedia Act (TMG).
      </p>
      <p>
        ...
        illegal activities were detected in them. As soon as we become aware of
        illegal activities or violations, we will remove the corresponding link.
      </p>
      <p>
        Copyright: Our web pages and their content (texts, photos, graphics,
        design) are subject to German copyright law. Unless otherwise agreed by
        law, the use, reproduction, copying or modification of the content is
        subject to copyright. Exceptions must be approved in writing by the
